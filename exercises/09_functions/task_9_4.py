...
* intf_vlan_dict - очікує як аргумент словник із зіставленням інтерфейс-VLAN
  (приклад access_dict)
* access_template - чекає як аргумент список рядків, які треба додати для
...
символу нового рядка. Якщо в шаблоні access_template є команда switchport
...
переконатися, що у кінцевому списку правильні номери інтерфейсів та вланів.
